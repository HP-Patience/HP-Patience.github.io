    ...
    render() {
        ...
        return <head>
            ...
            <style dangerouslySetInnerHTML={{ 
                __html: `body{opacity:0;transition:opacity .3s ease}.fouc-fix body{opacity:1}.article-excerpt{max-height:180px;overflow:hidden;position:relative}.article-excerpt::after{content:'';position:absolute;bottom:0;left:0;right:0;height:60px;background:linear-gradient(transparent,#fff)}` 
            }} />
            <script dangerouslySetInnerHTML={{ 
                __html: `(function(){var n=localStorage.getItem("night");if(n==="true"||n===null){document.documentElement.classList.add("night-mode")}})();` 
            }}></script>
            ...
            <link rel="stylesheet" href={url_for('/css/busuanzi.css')} />
